...
class BaseDatasource(
    ...
    def category_class(self):
        # link to derivative of DatasetCategory
        raise NotImplementedError()
    ...
    def data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "categories": [o.data for o in self.categories],
    ...
    def update_from_object(self, obj: Dict[str, Any]) -> None:
        ...
        self.categories = (
            self.get_fk_many_from_list(
                obj["categories"], self.categories, self.category_class, "table_name"
            )
            if self.category_class and "categories" in obj
            else []
        )
