    ...
    def run(self) -> Model:
        ...
        try:
            ...
            if self._properties.get("json_metadata"):
                ...
                json_data = json.loads(self._properties.get("json_metadata", "{}"))
                data_mobile_json_metadata = json.loads(self._properties.get("mobile_json_metadata", "{}"))
                json_data["mobile_json_metadata"] = data_mobile_json_metadata
